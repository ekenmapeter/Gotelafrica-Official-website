        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div class="flex items-center gap-4">
                    <a href="{{ route('allusers') }}" class="flex items-center gap-2 bg-white text-blue-600 font-medium py-2 px-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 border border-blue-100 hover:border-blue-200">
                    ...
                    <div class="flex items-center gap-6 mb-6">
                        <div class="h-20 w-20 rounded-full bg-blue-100 flex items-center justify-center">
                            <span class="text-2xl text-blue-600 font-medium">
                                {{ strtoupper(substr($user->first_name, 0, 1)) }}{{ strtoupper(substr($user->other_name, 0, 1)) }}
                            </span>
                        </div>
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900">{{ $user->first_name }} {{ $user->other_name }}</h2>
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">₦{{ number_format($user->wallet->balance ?? 0, 2) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.user.adjust-funds', $user->id) }}" method="POST" class="space-y-6">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
