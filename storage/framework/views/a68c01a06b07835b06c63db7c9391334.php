...
<body>
    <div class="container">
        <div class="header">
            <img src="<?php echo e(asset('images/logo.jpeg')); ?>" alt="Gotelafrica Logo" style="max-width: 150px; margin-bottom: 20px;">
            <h1 style="margin: 0;">🎉 Thank You for Submitting! 🎉</h1>
        </div>

        <div class="content">
            <p style="font-size: 18px;">Dear <strong><?php echo e($submission->full_name); ?></strong>,</p>
            ...
            <div class="submission-details">
                ...
                <p><strong>🎯 Submission ID:</strong> <?php echo e($submission->id); ?></p>
                <p><strong>📅 Date Submitted:</strong> <?php echo e($submission->created_at->format('F j, Y')); ?></p>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\Gotelafrica-Official-website\resources\views\emails\user-confirmation.blade.php ENDPATH**/ ?>