...
<?php $component->withAttributes([]); ?>
    <div class="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 px-4 py-8">
            ...
            <div class="bg-gradient-to-r from-emerald-600 to-emerald-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white text-3xl font-bold"><?php echo e($totalUsers); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white text-3xl font-bold">₦<?php echo e(number_format($totalWallet, 2)); ?></p>
                    </div>
                    <div class="bg-white bg-opacity-20 p-3 rounded-full">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bg-gradient-to-r from-purple-600 to-purple-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white text-3xl font-bold"><?php echo e($totalTransaction); ?></p>
                    </div>
                    <div class="bg-white bg-opacity-20 p-3 rounded-full">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bg-gradient-to-r from-amber-600 to-amber-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white text-3xl font-bold"><?php echo e($totalActiveInvestment); ?></p>
                    </div>
                    <div class="bg-white bg-opacity-20 p-3 rounded-full">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bg-gradient-to-r from-red-600 to-red-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white text-3xl font-bold">₦<?php echo e(number_format($total_asset, 2)); ?></p>
                    </div>
                    <div class="bg-white bg-opacity-20 p-3 rounded-full">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white text-3xl font-bold"><?php echo e($totalProduct); ?></p>
                    </div>
                    <div class="bg-white bg-opacity-20 p-3 rounded-full">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <a href="<?php echo e(route('all-transaction')); ?>" class="bg-gray-800 hover:bg-gray-700 rounded-lg p-4 text-center transition-all duration-300 transform hover:-translate-y-1">
            ...
            <a href="<?php echo e(route('fund-wallet')); ?>" class="bg-gray-800 hover:bg-gray-700 rounded-lg p-4 text-center transition-all duration-300 transform hover:-translate-y-1">
            ...
            <a href="<?php echo e(route('withdraw-request')); ?>" class="bg-gray-800 hover:bg-gray-700 rounded-lg p-4 text-center transition-all duration-300 transform hover:-translate-y-1">
            ...
            <a href="<?php echo e(route('deposit')); ?>" class="bg-gray-800 hover:bg-gray-700 rounded-lg p-4 text-center transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div class="bg-gray-800 rounded-xl p-6 shadow-lg">
            ...
            <div class="space-y-3">
                <!-- All Users -->
                <a href="<?php echo e(route('allusers')); ?>" class="flex items-center justify-between p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-all duration-300">
                ...
                <!-- All Orders -->
                <a href="<?php echo e(route('all-order')); ?>" class="flex items-center justify-between p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-all duration-300">
                    <div class="flex items-center">
                ...
                <!-- All Products -->
                <a href="<?php echo e(route('all-product')); ?>" class="flex items-center justify-between p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-all duration-300">
                    <div class="flex items-center">
                ...
                <!-- All Contestants -->
                <a href="<?php echo e(route('admin.contest')); ?>" class="flex items-center justify-between p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-all duration-300">
                    <div class="flex items-center">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Gotelafrica-Official-website\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>