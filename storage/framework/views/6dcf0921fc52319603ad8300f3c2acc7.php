...
<body class="font-sans bg-gray-50">
    ...
    <section class="relative bg-gradient-to-r from-green-500 to-blue-500 text-white py-20">
        ...
        <div class="relative z-10 text-center">
            ...
            <a class="bg-yellow-500 text-black font-semibold py-2 px-6 rounded-full shadow-lg hover:bg-yellow-600 transition" href="<?php echo e(route('apply')); ?>">Submit Your Entry</a>
        </div>
    </section>
