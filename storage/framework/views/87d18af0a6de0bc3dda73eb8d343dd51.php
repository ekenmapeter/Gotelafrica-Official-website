...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col items-center justify-center px-2 py-8  mb-44">
        ...
        <div class="flex  w-1/2 gap-4 items-center justify-start">
            ...
            <p class="text-white text-2xl font-bold"><?php echo e($maskedPhone); ?></p>
            ...
            <div class="flex gap-4 w-full bg-black text-white text-center lg:px-4 px-4 py-4 rounded-lg">
                <div class="w-full">
                    <div class="text-left">
                        ...
                        <?php if($recharge): ?>
                        <p class="text-white lg:text-3xl text-1xl font-extrabold">₦<?php echo e(number_format($recharge->amount, 2)); ?></p>
                    <?php else: ?>
                ...
                <div class="w-full">
                    <div class="text-left">
                        ...
                        <p class="text-white lg:text-3xl text-1xl font-extrabold">₦<?php echo e(number_format($wallet->balance, 2)); ?></p>
            ...
            <div class="flex gap-4 w-full bg-black text-white text-center lg:px-12 px-4 py-4 rounded-lg">
                <div class="w-full">
                    <div class="text-left">
                        ...
                        <p class="text-white text-1xl font-extrabold">
                            ₦ <?php echo e(number_format($total_income, 2)); ?>
                ...
                <div class="w-full">
                    <div class="text-left">
                        ...
                        <?php if($total_recharge): ?>
                        <p class="text-white text-1xl font-extrabold">
                            ₦ <?php echo e(number_format($total_recharge, 2)); ?>
                ...
                <div class="w-full">
                    <div class="text-left">
                        ...
                        <?php if($total_asset): ?>
                        <p class="text-white text-1xl font-extrabold">
                            ₦ <?php echo e(number_format($total_asset, 2)); ?>
            ...
            <div class="flex gap-4 w-full bg-black text-white text-center lg:px-12 px-4 py-4 rounded-lg">
                <div class="w-full">
                    <div class="text-left">
                        ...
                        <?php if($totalWithdraw): ?>
                        <p class="text-white text-1xl font-extrabold">
                            ₦ <?php echo e(number_format($totalWithdraw, 2)); ?>
                ...
                <div class="w-full">
                    <div class="text-left">
                        ...
                        <?php if($today_income): ?>
                        <p class="text-white text-1xl font-extrabold">
                            ₦ <?php echo e(number_format($today_income, 2)); ?>
                ...
                <div class="w-full">
                    <div class="text-left">
                        ...
                        <?php if(isset($get_team_income_percentage)): ?>
                        <p class="text-white text-1xl font-extrabold">₦<?php echo e($get_team_income_percentage); ?></p>
                        <?php else: ?>
                        <p class="text-white text-1xl font-extrabold">₦0</p>
                        <?php endif; ?>
        ...
        <div class="flex bg-black items-center lg:gap-20 gap-4 justify-center py-4 lg:px-12 px-2 rounded-lg">
            <a href="<?php echo e(route('transaction')); ?>" class="flex flex-col items-center justify-center">
            ...
            <a href="<?php echo e(route('recharge')); ?>" class="flex flex-col items-center justify-center">
                <svg class="lg:w-14 w-6 lg:h-14 h-6 text-white" aria-hidden="true"
            ...
            <a href="<?php echo e(route('withdraw')); ?>" class="flex flex-col items-center justify-center">
            ...
            <a href="<?php echo e(route('refer')); ?>" class="flex flex-col items-center justify-center">
                <svg class="lg:w-14 w-6 lg:h-14 h-6 text-white" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path
        ...
        <div class="flex flex-col gap-2 py-4 lg:w-1/2 mt-2 w-full px-4 bg-black rounded-lg space-y-4 ">
            <a href="<?php echo e(route('myorder')); ?>" class="flex gap-2 hover:bg-gray-500 hover:py-2 hover:px-2 hover:rounded-lg">
            ...
            <a href="<?php echo e(route('mybankaccount')); ?>" class="flex gap-2 hover:bg-gray-500 hover:py-2 hover:px-2 hover:rounded-lg">
                <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor" viewBox="0 0 20 20">
                    <path
            ...
            <div class="flex gap-2 hover:bg-gray-500 hover:py-2 hover:px-2 hover:rounded-lg">
                ...
                <a href="<?php echo e(route('resetpassword')); ?>" class="flex justify-between w-full">
            ...
            <a href="<?php echo e(route('withdrawpassword')); ?>" class="flex gap-2 hover:bg-gray-500 hover:py-2 hover:px-2 hover:rounded-lg">
                <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="<?php echo e(route('customerservice')); ?>" class="flex gap-2 hover:bg-gray-500 hover:py-2 hover:px-2 hover:rounded-lg">
                <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor" viewBox="0 0 20 20">
                    <path
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Gotelafrica-Official-website\resources\views/dashboard.blade.php ENDPATH**/ ?>