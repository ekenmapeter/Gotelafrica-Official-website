...
<p class="text-white text-2xl font-bold">All <?php echo e($allTransactionCount); ?> Transaction</p>
        ...
        <div class="flex flex-col w-1/2 gap-4 items-center justify-center">
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $allTransaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <tr class="bg-white border-b hover:bg-gray-50">
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap"><?php echo e($data->id); ?></td>
                                <td class="px-6 py-4"><a href="<?php echo e(route('admin/details', $data->id)); ?>"><?php echo e($data->name); ?></a></td>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Gotelafrica-Official-website\resources\views\admin\all_transaction.blade.php ENDPATH**/ ?>