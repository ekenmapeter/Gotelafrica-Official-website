    ...
    <nav class="fixed w-full z-20 top-0 start-0 bg-black">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="images/logo.jpeg" class="h-8 rounded-lg" alt="<?php echo e(config('app.name', 'Gotelafrica')); ?>" />
...
<?php /**PATH C:\xampp\htdocs\Gotelafrica-Official-website\resources\views/about.blade.php ENDPATH**/ ?>