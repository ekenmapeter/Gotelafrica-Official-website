                        ...
                        <?php else: ?>
                            <form id="uploadForm" action="<?php echo e(route('contest.upload')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="file" name="video" id="video" accept="video/*" required class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
...
function copyShareLink(button) {
    ...
    try {
        ...
        tooltip.className = 'fixed bottom-4 right-4 bg-green-500 text-white px-4 py-2 rounded shadow-lg';
