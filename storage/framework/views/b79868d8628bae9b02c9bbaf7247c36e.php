        ...
        <div>
            ...
            <select id="user" name="user" class="bg-gray-50 border border-gray-300 text-black font-extrabold hover:text-black text-sm rounded-lg block w-full p-2.5" name="user" required autocomplete="user">
                ...
                <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option class="hover:text-black" value="<?php echo e($data->id); ?>"><?php echo e($data->first_name); ?> <?php echo e($data->other_name); ?></option>
...
<?php endif; ?>
<?php /**PATH /home/goteonji/public_html/resources/views/admin/fund_wallet.blade.php ENDPATH**/ ?>