        ...
        <div class="flex flex-col lg:w-1/2 w-full gap-4 items-center justify-center  mb-22">
            ...
            <div class="w-full p-6 bg-white rounded shadow-sm my-6" id="invoice">
                ...
                <div class="grid grid-cols-2 items-center">
                    <div>
                        <!--  Company logo  -->
                        <img class="h-44 w-44 rounded-lg" src="../product_image/<?php echo e($invest->image); ?>"
                            alt="<?php echo e($invest->name); ?>">
                    </div>
                    ...
                    <div class="text-right">
                        <div class="flex gap-2 items-center justify-end bg-green-400 px-4 rounded-lg">
                            ...
                            <p class="text-1xl text-black font-extrabold">₦<?php echo e(number_format($recharge->amount, 2)); ?></p>

                        </div>
                        <p>
                            <?php echo e($invest->name); ?>

                        </p>
                        <p class="text-gray-500 text-sm">
                            <?php echo e($invest->validity_period); ?> Days
                        </p>
                        <p class="text-gray-500 text-sm mt-1">
                            <?php echo e($invest->business_value); ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    <td class="px-2 py-4 whitespace-nowrap"><?php echo e($invest->price); ?></td>
                                    <td class="px-2 py-4 whitespace-nowrap"><?php echo e($invest->daily_income); ?></td>
                                    <td class="px-2 py-4 whitespace-nowrap"><?php echo e($invest->validity_period); ?></td>
                                    <td class="px-2 py-4 whitespace-nowrap"><?php echo e($invest->total_income); ?></td>
                                    <td class="px-2 py-4 whitespace-nowrap"><?php echo e($invest->business_value); ?></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
                                    <td class="px-6 py-4" colspan="5">
                                        <form method="POST" action="<?php echo e(route('investPay')); ?>">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="id" value="<?php echo e($invest->id); ?>">
                                            <input type="hidden" name="price" value="<?php echo e($invest->price); ?>">
                                            <input type="hidden" name="daily_income" value="<?php echo e($invest->daily_income); ?>">
                                            <input type="hidden" name="validity_period" value="<?php echo e($invest->validity_period); ?>">
                                            <input type="hidden" name="total_income" value="<?php echo e($invest->total_income); ?>">
                                            <input type="hidden" name="business_value" value="<?php echo e($invest->business_value); ?>">
                                            <input type="hidden" name="name" value="<?php echo e($invest->name); ?>">
                                            <input type="hidden" name="description" value="<?php echo e($invest->description); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Gotelafrica-Official-website\resources\views\investment_details.blade.php ENDPATH**/ ?>