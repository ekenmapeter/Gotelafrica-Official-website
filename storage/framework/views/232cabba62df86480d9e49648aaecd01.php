            ...
            <nav class="fixed w-full z-20 top-0 start-0 bg-black">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span class="self-center text-1xl font-semibold whitespace-nowrap">Administrator</span>
                    </a>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(url('/administrator')); ?>"
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/goteonji/public_html/resources/views/components/navbar.blade.php ENDPATH**/ ?>