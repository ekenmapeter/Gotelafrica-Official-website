    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 px-4 py-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                ...
                <!-- Search Form -->
                <form method="GET" action="<?php echo e(route('running-orders')); ?>" class="w-full md:w-auto">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-gray-800"><?php echo e($total_orders ?? 0); ?></p>
                        </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-purple-600">₦<?php echo e(number_format($daily_income ?? 0, 2)); ?></p>
                        </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-amber-600">₦<?php echo e(number_format($total_investment ?? 0, 2)); ?></p>
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $running_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($order->name); ?></div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500"><?php echo e($order->created_at->diffForHumans()); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-green-600">
                                    ₦<?php echo e(number_format($order->daily_income, 2)); ?>
                ...
                <!-- Pagination -->
                <?php if($running_product->hasPages()): ?>
                <div class="px-6 py-3 bg-gray-50 border-t border-gray-200">
                    <?php echo e($running_product->appends(request()->query())->links()); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Gotelafrica-Official-website\resources\views/admin/all_order.blade.php ENDPATH**/ ?>