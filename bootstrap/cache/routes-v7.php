...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::LcgRMalEPm0F8kWD',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'withdrawal.password.store',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::59aUMgk98AiQfrFv',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::8OWA0EamxuKkKxLS',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::73GZKTUndDAwxC2B',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::zipKM6MG2MfER8Mq',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::SiDse3ve5VJO4iMA',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::8LJTBipi9dCawwc4',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/a(?|dmin/(?|details/([^/]++)(*:36)|withdraw/details/([^/]++)(*:68)|submission(?|/([^/]++)(?|(*:100)|/approve(*:116))|s/([^/]++)/approve(*:143)))|pprove/withdraw/([^/]++)(*:177))|/users/([^/]++)(?|(*:204)|/adjust\\-funds(*:226)|(*:234))|/i(?|mpersonate/([^/]++)(*:267)|nvest/([^/]++)(*:289))|/de(?|posit/(?|details/([^/]++)(*:329)|approve/([^/]++)(*:353)|reject/([^/]++)(*:376))|lete/submission/([^/]++)(*:409)|tails/([^/]++)(*:431))|/product/(?|activate/([^/]++)(*:469)|de(?|activate/([^/]++)(*:499)|lete/([^/]++)(*:520)))|/re(?|ject/withdraw/([^/]++)(*:558)|set\\-password/([^/]++)(*:588))|/contest/vote/([^/]++)(?|(*:622)|/submit(*:637))|/verify\\-email/([^/]++)/([^/]++)(*:678))/?$}sDu',
    ),
    3 => 
    array (
      36 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.submission.approve',
          ),
          1 => 
          array (
            0 => 'id',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.user.adjust-funds',
          ),
          1 => 
          array (
            0 => 'id',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AdministratorController@viewUser',
        'controller' => 'App\\Http\\Controllers\\AdministratorController@viewUser',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    'admin.user.adjust-funds' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'users/{id}/adjust-funds',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\AdministratorController@adjustUserFunds',
        'controller' => 'App\\Http\\Controllers\\AdministratorController@adjustUserFunds',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'admin.user.adjust-funds',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AdministratorController@impersonate',
        'controller' => 'App\\Http\\Controllers\\AdministratorController@impersonate',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AdministratorController@stopImpersonating',
        'controller' => 'App\\Http\\Controllers\\AdministratorController@stopImpersonating',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'admin/submission/{id}/approve',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\AdministratorController@approveSubmission',
        'controller' => 'App\\Http\\Controllers\\AdministratorController@approveSubmission',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'admin.submission.approve',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    'withdrawal.password.store' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'withdrawal-password',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserController@storeWithdrawalPassword',
        'controller' => 'App\\Http\\Controllers\\UserController@storeWithdrawalPassword',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'withdrawal.password.store',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ContestSubmissionController@create',
        'controller' => 'App\\Http\\Controllers\\ContestSubmissionController@create',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
